...
type UserResponse struct {
	...
	Name          string                 `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"` // NamaLengkap
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_proto_rawDesc = "" +
	...
	"\vUserService\x123\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x12.user.UserResponseB3Z1github.com/Kevinmajesta/common-protos/gen/go/userb\x06proto3"
